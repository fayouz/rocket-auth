  ...
  icon: {
    ...
    clientBundle: {
      ...
      icons: [
        ...
        'lucide:play', 'lucide:key-round', 'lucide:code', 'lucide:shield-check', 'lucide:lock', 'lucide:users',
        'lucide:user-round', 'lucide:log-in', 'lucide:app-window', 'lucide:layout-grid', 'lucide:layout-dashboard',
        'lucide:activity', 'lucide:refresh-cw', 'lucide:history', 'lucide:arrow-right', 'lucide:book-open', 'lucide:laptop',
        'simple-icons:github', 'simple-icons:nuxtdotjs', 'simple-icons:symfony',
        ...
        'vscode-icons:file-type-dotenv', 'vscode-icons:file-type-yaml', 'vscode-icons:file-type-light-yaml',
      ],
    },
  },
  nitro: {
